...
#'
#' This is a data frame of adjectives in the English language to use as an attribute in generating a codename.
#'
...
#'
#' This is a data frame of animals in the English language to use as an object in generating a codename.
#'
...
#'
#' This is a data frame of colors in the English language to use as an attribute in generating a codename.
#'
...
#'
#' This is a data frame of gods in the English language to use as an object in generating a codename.
#'
...
#'
#' This is a data frame of nouns in the English language to use as an object in generating a codename.
#'
...
#'
#' This is a data frame of adjectives from the "Wu-Tang Name Generator" to use as an attribute in generating a codename.
#'
...
#'
#' This is a data frame of nouns from the "Wu-Tang Name Generator" to use as an object in generating a codename.
#'
