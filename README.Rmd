...
Here's a running list of projects that make use of `{codename}`. If you would look your project included, please [raise an issue](https://github.com/svmiller/codename/issues) on the project's Github.
